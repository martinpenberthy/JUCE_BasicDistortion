...
/**
*/
class BasicDistortionAudioProcessor  : public juce::AudioProcessor, public juce::ValueTree::Listener
...
public:
  ...
  float distThreshold = 1.0f;
  int distModValue = 0;
  int distSoftAmount = 0;
  int distMode = 0;
